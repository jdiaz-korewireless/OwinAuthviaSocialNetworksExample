...
namespace AuthDomain.Resources {
    ...
    internal class Exceptions {
        ...
        /// <summary>
        ///   Looks up a localized string similar to More than one user found for the email &apos;{0}&apos;.
        /// </summary>
        internal static string MoreThanOneUserFoundByEmail {
            get {
                return ResourceManager.GetString("MoreThanOneUserFoundByEmail", resourceCulture);
            }
        }
        
        /// <summary>
        ///   Looks up a localized string similar to More than one user found for the provider &apos;{0}&apos; and the key &apos;{1}&apos;.
        /// </summary>
        internal static string MoreThanOneUserFoundByExtProvider {
            get {
                return ResourceManager.GetString("MoreThanOneUserFoundByExtProvider", resourceCulture);
            }
        }
